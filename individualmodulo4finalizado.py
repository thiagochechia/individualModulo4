# -*- coding: utf-8 -*-
"""individualModulo4finalizado.ipynb
...
print('{:.2f}'.format(relatorio1[:7]['Horas Trabalhadas'].mean()))
...
print('{:.2f}'.format(relatorio1[:7]['Bugs Corrigidos'].mean()))
...
print('{:.2f}'.format(relatorio1[:7]['Tarefas Concluídas'].mean()))

"""- PRODUTIVIDADE DIÁRIA  ( TAREFAS CONCLUÍDAS POR HORA )"""

ProdutividadeDiaria = relatorio1[:7]['Horas Trabalhadas'].sum() / relatorio1[:7]['Tarefas Concluídas'].sum()
print('{:.2f}'.format(relatorio1[:7]['Horas Trabalhadas'].sum() / relatorio1[:7]['Tarefas Concluídas'].sum()))
